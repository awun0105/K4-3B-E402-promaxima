...
try:
    from codebase.providers.base import Provider, ToolCall
    from codebase.tools import TOOL_FUNCTIONS
...
class DiscordAssistantAgent:
    """Central Agent runner executing LLM completions with dynamic tool calling for K4 Discord Assistant."""
...
HelpdeskAgent = DiscordAssistantAgent
