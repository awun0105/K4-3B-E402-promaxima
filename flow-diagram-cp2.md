...
flowchart TD
    ...
    E -- Không --> F[Bot không đoán]
    F --> G{Có thông tin bổ sung từ người dùng không?}
    G -- Có --> H[Bot yêu cầu xác nhận thêm 1 thông tin ngắn]
    H --> E
    G -- Không --> I[Bot tag TA / chuyển tiếp hỗ trợ]
    I --> J[TA trả lời trực tiếp trong thread]

    E -- Có --> K{Mức chắc chắn cao và trùng khớp 100% với nguồn không?}
    K -- Có --> L[Bot trả lời: deadline + link nguồn chính thức]
    L --> M[Học viên nhận câu trả lời rõ ràng]

    K -- Không --> N[Bot không trả lời chắc chắn]
    N --> O{User muốn sửa / bổ sung thêm thông tin không?}
    O -- Có --> P[Bot yêu cầu 1 câu hỏi ngắn để làm rõ]
    P --> E
    O -- Không --> I
